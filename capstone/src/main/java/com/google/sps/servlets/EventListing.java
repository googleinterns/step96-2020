...
public class EventListing extends HttpServlet {
  ...
  public Calendar setUp(HttpServletResponse response) throws GeneralSecurityException, IOException {
    ...
    String redirectUrl = "https://capstone-96-step-2020.uc.r.appspot.com/eventlisting.html";
    ...
    // Exchange
    GoogleTokenResponse responses =
        flow.newTokenRequest(code).setRedirectUri(redirectUrl).execute();
